...
public class MSMLegacy {
	...
	public void onPreInit(FMLPreInitializationEvent event) {
		 ...
		 feast = registry.registerEnchantment(config.getSwordEnchantment("feast", dawnStar, Rarity.COMMON,  1, 3), "feast");
		 vitality = registry.registerEnchantment(config.getSwordEnchantment("vitality", dawnStar, Rarity.RARE, 1, 1), "vitality");

		 gladiolus = registry.registerItem(new ItemSword(config.getMaterial("gladiolus", 3, 645, 8, 6, 10)), "gladiolus");
		 venomousAspect = registry.registerEnchantment(config.getSwordEnchantment("venomous_aspect", dawnStar, Rarity.COMMON,  1, 3), "venomous_aspect");
		 absorb = registry.registerEnchantment(config.getSwordEnchantment("absorb", dawnStar, Rarity.RARE, 1, 1), "absorb");
		
		 draconicBlade = registry.registerItem(new ItemSword(config.getMaterial("draconic_blade", 3, 1089, 8, 7, 16)), "draconic_blade");
		 keenEdge = registry.registerEnchantment(config.getSwordEnchantment("keen_edge", dawnStar, Rarity.COMMON,  1, 3), "keen_edge");
		 scorn = registry.registerEnchantment(config.getSwordEnchantment("scorn", dawnStar, Rarity.RARE, 1, 1), "scorn");
		
		 eyeEndBlade = registry.registerItem(new ItemSword(config.getMaterial("eye_end_blade", 3, 1580, 8, 8, 22)), "eye_end_blade");
		 enderPulse = registry.registerEnchantment(config.getSwordEnchantment("ender_pulse", dawnStar, Rarity.COMMON,  1, 3), "ender_pulse");
		 enderAura = registry.registerEnchantment(config.getSwordEnchantment("ender_aura", dawnStar, Rarity.RARE, 1, 1), "ender_aura");
		
		 crystalineBlade = registry.registerItem(new ItemSword(config.getMaterial("crystaline_blade", 3, 570, 8, 5, 28)), "crystaline_blade");
		 greed = registry.registerEnchantment(config.getSwordEnchantment("greed", dawnStar, Rarity.COMMON,  1, 3), "greed");
		 wisdom = registry.registerEnchantment(config.getSwordEnchantment("wisdom", dawnStar, Rarity.RARE, 1, 1), "wisdom");
		
		 glacialBlade = registry.registerItem(new ItemSword(config.getMaterial("glacial_blade", 3, 680, 8, 6, 15)), "glacial_blade");
		 frozenAspect = registry.registerEnchantment(config.getSwordEnchantment("frozen_aspect", dawnStar, Rarity.COMMON,  1, 3), "frozen_aspect");
		 frostWave = registry.registerEnchantment(config.getSwordEnchantment("frost_wave", dawnStar, Rarity.RARE, 1, 1), "frost_wave");
		
		 aeithersGuard = registry.registerItem(new ItemSword(config.getMaterial("aethers_guard", 3, 1796, 8, 8, 22)), "aethers_guard");
		 ascension = registry.registerEnchantment(config.getSwordEnchantment("ascension", dawnStar, Rarity.COMMON,  1, 3), "ascension");
		 descension = registry.registerEnchantment(config.getSwordEnchantment("descension", dawnStar, Rarity.RARE, 1, 1), "descension");
		
		 withersBane = registry.registerItem(new ItemSword(config.getMaterial("wither_bane", 3, 1869, 8, 6, 16)), "wither_bane");
		 consumingShadows = registry.registerEnchantment(config.getSwordEnchantment("consuming_shadows", dawnStar, Rarity.COMMON,  1, 3), "consuming_shadows");
		 decay = registry.registerEnchantment(config.getSwordEnchantment("decay", dawnStar, Rarity.RARE, 1, 1), "decay");
		
		 adminiumArk = registry.registerItem(new ItemSword(config.getMaterial("adminium_ark", 3, 9999999, 8, 99999, 999)), "adminium_ark");
		 stealth = registry.registerEnchantment(config.getSwordEnchantment("stealth", dawnStar, Rarity.COMMON,  1, 3), "stealth");
		 extinction = registry.registerEnchantment(config.getSwordEnchantment("extinction", dawnStar, Rarity.RARE, 1, 1), "extinction");
	}
}